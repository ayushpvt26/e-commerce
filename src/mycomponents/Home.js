    ...
    return (
        ...
        <Imageslider />
            ...
            <div className="categories">
                <div><Link to="/Main"><img src={require("./images/categorie1.jpg")} alt="Wedding Store" /><br />Wedding Store</Link></div>
                <div><Link to="/Main"><img src={require("./images/categorie2.jpg")} alt="Wedding Store" /><br />Wedding Store</Link></div>
                <div><Link to="/Main"><img src={require("./images/categorie3.jpg")} alt="Wedding Store" /><br />Wedding Store</Link></div>
                <div><Link to="/main"><img src={require("./images/categorie5.jpg")} alt="Wedding Store" /><br />Wedding Store</Link></div>
                <div><Link to="/main"><img src={require("./images/categorie4.jpg")} alt="Wedding Store" /><br />Wedding Store</Link></div>
            </div>
<br></br>
...
<br></br>
            <div className='online-collection-heading'>
                ...
                <p>ELEATE YOUR STYLE: SHOP THE FRESHEST STYLE FROM OUR ONLINE EXCLUSIVE COLLECTION</p>
            </div>
            <br></br>
